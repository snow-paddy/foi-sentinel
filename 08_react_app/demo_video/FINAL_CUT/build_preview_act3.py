#!/usr/bin/env python3
"""build_preview_act3.py - assemble the ACT 3 PREVIEW only (for review).
Inbox card, then captioned Act 3 with its inner estate card. Mirrors the
Act-3 block of the final stitch (build_full.py).
"""
...
WORK = os.path.join(HERE, ".preview3_tmp")
CARDS = os.path.join(HERE, "cards")
OUT = os.path.join(HERE, "ACT3_PREVIEW.mp4")
...
def main():
    ...
    print(f"\nDONE -> ACT3_PREVIEW.mp4  {dur}s  {size:.1f} MB")
