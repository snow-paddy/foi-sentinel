#!/usr/bin/env python3
"""build_preview.py - assemble the ACT 1 PREVIEW only (for review).
Title + command cards, then trimmed/re-captioned Act 1 with its inner segment
cards. Mirrors the Act-1 block of the final stitch. Arch card omitted pending
the Slides decision.
"""
...
WORK = os.path.join(HERE, ".preview_tmp")
CARDS = os.path.join(HERE, "cards")
OUT = os.path.join(HERE, "ACT1_PREVIEW.mp4")
...
HOLD = {"00_title": 4.5, "01_command": 5.5, "02_caseload": 3.5,
        "03_quickwins": 3.5, "04_knowledge": 3.5}
...
def main():
    ...
    print(f"\nDONE -> ACT1_PREVIEW.mp4  {dur}s  {size:.1f} MB")
