...
const TYPES: { value: ResponseType; label: string; hint: string }[] = [
  ...
  { value: "MIXED_S21", label: "Part published, part new (mixed)", hint: "Some of the request is already published, so we signpost that part under s.21, and answer the remainder directly." },
]
